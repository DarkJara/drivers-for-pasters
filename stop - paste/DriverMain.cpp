...
INT64 driver_main() {
	print("STOP FUCKING PASTING KIDS :), STOP FUCKING PASTING KIDS :), STOP FUCKING PASTING KIDS :), STOP FUCKING PASTING KIDS :), STOP FUCKING PASTING KIDS :), STOP FUCKING PASTING KIDS :), STOP FUCKING PASTING KIDS :), STOP FUCKING PASTING KIDS :)");
	...
	if (DriverObject) {
		*(PVOID*)&OriginalPtr = InterlockedExchangePointer((void**)&DriverObject->MajorFunction[IRP_BUFFERED_IO], HookControl);
		SharedBuffer = (PVOID)Utils::Registry::ReadRegistry<LONG64>(RegPath, RTL_CONSTANT_STRING(L"xxx"));
		SharedPid = (UINT)Utils::Registry::ReadRegistry<LONG64>(RegPath, RTL_CONSTANT_STRING(L"xx"));
